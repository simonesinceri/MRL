% Questa la metto all'interno di un for con 6 iterazioni cos' da simulare
% il mio ambiente

function [allData, scenario, sensor] = Road_Scenario(x_iniz,y_iniz,x_next,y_next,y,i)
%Road_Scenario - Returns sensor detections
%    allData = Road_Scenario returns sensor detections in a structure
%    with time for an internally defined scenario and sensor suite.
%
%    [allData, scenario, sensors] = Road_Scenario optionally returns
%    the drivingScenario and detection generator objects.

% Generated by MATLAB(R) 9.11 (R2021b) and Automated Driving Toolbox 3.4 (R2021b).
% Generated on: 21-Mar-2022 17:14:02

% Create the drivingScenario object and ego car
[scenario, egoVehicle] = createDrivingScenario(x_iniz,y_iniz,x_next,y_next);
...
function [scenario, egoVehicle] = createDrivingScenario(x_iniz,y_iniz,x_next,y_next)
...
waypoints = [y_iniz x_iniz 0;   % attenzione alla posizione di y e x
    y_next x_next 0];
    %y_next+5 x_next 0;
    %y_next+10 x_next 0];
    %30 0 0];
